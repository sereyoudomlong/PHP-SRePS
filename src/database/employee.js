/**
 * Customer.js
 * The customer handler for the database
 */
...
module.exports = {
    ...
    init: function(stockDatabase) {
        ...
        this.db = this.database.createDatabase("employee");
        this.database.insert(this.db, {"_id": "default", "firstName": "employee", "lastName": ""}).catch((error)=>{});
    },

    /**
     * Add an customer to the database
